...
namespace Microsoft.Robotics.Services.ObstacleAvoidanceDrive
{
    ...
    public partial class ObstacleAvoidanceDriveService : DsspServiceBase
    {
        ...
        /// uncontrollable
        /// </summary>
        private const double DefaultMaxPowerDifferenceBetweenWheels = 0.3;
        ...
        protected override void Start()
        {
			...
			if (this.state.MaxPowerDifferenceBetweenWheels <= 0 || this.state.MaxPowerDifferenceBetweenWheels > 2)
			{
				this.state.MaxPowerDifferenceBetweenWheels = DefaultMaxPowerDifferenceBetweenWheels;
			}
        ...
        private void NormalizeRotationSpeed(gendrive.SetDrivePower setPower)
        {
            ...
            if (this.state.MaxPowerDifferenceBetweenWheels < currentPowerDifference)
            {
				double scalingFactor = currentPowerDifference / this.state.MaxPowerDifferenceBetweenWheels;
                setPower.Body.LeftWheelPower /= scalingFactor;
                setPower.Body.RightWheelPower /= scalingFactor;
            }
        }
        ...
        {
            this.robotDrivePort.Post(new gendrive.RotateDegrees { Body = rotate.Body, ResponsePort = rotate.ResponsePort });
        }
